...
void AuthManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthManager::*)()>(_a, &AuthManager::authenticated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AuthManager::*)(const QString & )>(_a, &AuthManager::authenticationFailed, 1))
            return;
    }
}
...
// SIGNAL 1
void AuthManager::authenticationFailed(const QString & _t1)
{
